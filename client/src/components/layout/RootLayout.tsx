...
export default function RootLayout() {
  return (
    <div className="lg:grid lg:h-screen lg:grid-cols-12">
      ...
      <main className="mb-[60px] bg-[url('@/assets/layered-waves-haikei-light.svg')] bg-cover bg-fixed dark:bg-background dark:bg-[url('@/assets/layered-waves-haikei.svg')] lg:col-span-10 lg:mb-0 lg:h-screen lg:bg-local">
        <Outlet />
      </main>
    </div>
  );
